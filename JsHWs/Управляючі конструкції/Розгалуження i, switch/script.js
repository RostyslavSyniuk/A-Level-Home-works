...
//       cur = btn.onclick = function (){(entering = prompt("Enter current currrency"))};
//         val = btn.innerText = curency.shift();
//         }
//       alert(temp1.rates[entering]);
